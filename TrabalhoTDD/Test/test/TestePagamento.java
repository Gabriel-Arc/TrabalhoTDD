...
public class TestePagamento {
	...
	public void testaPagamento() {
		...
		fatura.efetuaPagamento(fatura,1,"07102020", "Boleto");
		Assertions.assertEquals(500.00,fatura.pagamentos[0].getValor_pago());
		Assertions.assertEquals("Não pago",fatura.getEstado());
		...
		Assertions.assertEquals("Boleto",fatura.pagamentos[2].getTipo_pagamento());
	}
}
